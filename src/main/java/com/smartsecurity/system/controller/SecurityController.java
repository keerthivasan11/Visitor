...
public class SecurityController {
    ...
    public ResponseEntity<Visitor> checkIn(HttpServletRequest httpRequest, @PathVariable Long id) {
        // userId could be used here for history if service is updated
    ...
    @GetMapping("/vehicles/tenant/{tenantId}")
    public ResponseEntity<List<Vehicle>> getVehiclesByTenant(@PathVariable Long tenantId) {
        return ResponseEntity.ok(vehicleService.getVehiclesByTenant(tenantId));
    }
